...
"%VS110COMNTOOLS%..\IDE\devenv.com" msvc/gtest.sln /build "Release|Win32"
"%VS110COMNTOOLS%..\IDE\devenv.com" msvc/gtest.sln /build "Debug|Win32"
"%VS110COMNTOOLS%..\IDE\devenv.com" msvc/gtest.sln /build "Release|x64"
"%VS110COMNTOOLS%..\IDE\devenv.com" msvc/gtest.sln /build "Debug|x64"
